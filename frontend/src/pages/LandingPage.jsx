...
const LandingPage = () => {
  return (
    <div className="min-h-screen bg-bg text-text selection:bg-cyan/30 selection:text-bg overflow-x-hidden font-body">
      ...
      <div className="fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-screen pointer-events-none -z-10">
        ...
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-blue/15 rounded-full blur-[120px] animate-pulse-slow font-head" style={{ animationDelay: '2s' }}></div>
      </div>

      {/* Header */}
      <header className="flex justify-between items-center px-6 md:px-12 py-6 border-b border-border bg-bg/70 backdrop-blur-xl sticky top-0 z-50">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-cyan flex items-center justify-center rounded-xl shadow-[0_0_15px_rgba(20,39,78,0.4)]">
        ...
        <nav className="hidden md:flex items-center gap-8 mr-auto ml-12">
           <a href="#features" className="text-xs font-bold text-text2 hover:text-text transition-colors uppercase tracking-widest">Features</a>
           <a href="#compliance" className="text-xs font-bold text-text2 hover:text-text transition-colors uppercase tracking-widest">Compliance</a>
           <a href="#security" className="text-xs font-bold text-text2 hover:text-text transition-colors uppercase tracking-widest">Security</a>
        </nav>
        <Link to="/auth" className="bg-cyan text-bg font-head font-black text-[11px] tracking-[0.1em] px-6 py-2.5 rounded-full hover:brightness-110 transition-all duration-300 shadow-[0_0_18px_rgba(20,39,78,0.35)] hover:shadow-[0_0_26px_rgba(20,39,78,0.55)] uppercase">
          Officer Login
        </Link>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-12 py-20 md:py-32 relative">
        <div className="text-center max-w-4xl mx-auto mb-20">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan/15 border border-cyan/30 text-cyan text-[10px] font-bold tracking-[0.2em] uppercase mb-8 animate-bounce">
            <Activity size={12} /> Live Processing Enabled
          </div>
          <h1 className="text-5xl md:text-8xl font-head font-black mb-8 leading-[0.9] tracking-tighter text-text">
            NEXT-GEN <br/>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-5">
             <Link to="/auth" className="bg-cyan text-bg font-head font-black tracking-widest py-4 px-10 rounded-2xl hover:brightness-110 transition-all group shadow-[0_0_25px_rgba(20,39,78,0.35)] flex items-center justify-center gap-3 text-xs">
               ENTER SYSTEM <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
             </Link>
             <button className="bg-bg2 border border-border text-text font-head font-black tracking-widest py-4 px-10 rounded-2xl hover:bg-bg3 transition-all flex items-center justify-center gap-3 text-xs">
        ...
        <div id="features" className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-32">
          <div className="glass-card p-10 hover:border-cyan/40 transition-all group">
            <div className="w-14 h-14 bg-cyan-dim rounded-2xl flex items-center justify-center text-cyan mb-8 group-hover:scale-110 transition-transform shadow-[0_0_15px_rgba(20,39,78,0.15)]">
              <Zap size={28} />
            </div>
            <h3 className="font-head text-2xl font-bold mb-4 text-text tracking-tight">Real-Time Lookup</h3>
          ...
          <div className="glass-card p-10 hover:border-green/40 transition-all group">
            <div className="w-14 h-14 bg-green-dim rounded-2xl flex items-center justify-center text-green mb-8 group-hover:scale-110 transition-transform shadow-[0_0_15px_rgba(74,155,111,0.12)]">
              <ShieldCheck size={28} />
            </div>
            <h3 className="font-head text-2xl font-bold mb-4 text-text tracking-tight">Compliance Engine</h3>
            <p className="text-text2 text-sm leading-relaxed font-medium">
          ...
          <div className="glass-card p-10 hover:border-blue/40 transition-all group sm:col-span-2 lg:col-span-1">
            <div className="w-14 h-14 bg-blue-dim rounded-2xl flex items-center justify-center text-blue mb-8 group-hover:scale-110 transition-transform shadow-[0_0_15px_rgba(170,205,220,0.15)]">
              <Search size={28} />
            </div>
            <h3 className="font-head text-2xl font-bold mb-4 text-text tracking-tight">Data Forensics</h3>
            <p className="text-text2 text-sm leading-relaxed font-medium">
        ...
        <div className="p-12 glass-card relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 text-center relative z-10">
             <div className="hover:-translate-y-1 transition-transform">
               <div className="font-head text-5xl font-black text-text mb-2 tracking-tighter">3.5k+</div>
             ...
             <div className="hover:-translate-y-1 transition-transform border-y sm:border-y-0 sm:border-x border-border py-8 sm:py-0">
        ...
        <div id="security" className="mt-32 text-center py-20 border-t border-border">
          <div className="flex justify-center mb-8">
            <Lock className="text-text3" size={32} />
          </div>
          <h2 className="font-head text-3xl font-bold text-text mb-6 tracking-tight uppercase">Bank-Grade Encryption</h2>
      ...
      {/* Footer */}
      <footer className="border-t border-border py-12 px-12 bg-bg2/50 backdrop-blur-md">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-3">
             <ShieldCheck size={20} className="text-cyan" />
             <span className="font-head font-black tracking-tighter text-text">VERIPLATE</span>
          </div>
